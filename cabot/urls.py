...
from cabot.cabotapp.views import (
    ...
    duplicate_icmp_check, duplicate_graphite_check, duplicate_http_check, duplicate_smtp_check, duplicate_jenkins_check,
    ...
    SmtpCheckCreateView, SmtpCheckUpdateView,
...
urlpatterns = [
     ...
     url(r'^smtpcheck/create/', view=SmtpCheckCreateView.as_view(),
        name='create-smtp-check'),
     url(r'^smtpcheck/update/(?P<pk>\d+)/',
        view=SmtpCheckUpdateView.as_view(), name='update-smtp-check'),
     url(r'^smtpcheck/duplicate/(?P<pk>\d+)/',
        view=duplicate_smtp_check, name='duplicate-smtp-check'),
